...
SECTION_NAME = "就业资讯-招聘信息"

BASE_URL = "https://job.bjtu.edu.cn/f/recruitmentinfo/ajax_frontRecruitinfo"
...
HEADERS = {
    ...
    "Referer": "https://job.bjtu.edu.cn/frontpage/bjtu/html/recruitmentinfoList.html?type=1",
