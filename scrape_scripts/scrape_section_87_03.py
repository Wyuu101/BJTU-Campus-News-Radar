...
SECTION_ID = "section_87_03"
# 培养方案
SECTION_NAME = "数统学院-研究生培养"
BASE_URL = "https://soms.bjtu.edu.cn/yjspy/pyfa2/"
MAX_PAGES = 1
...
def parse_page(
    ...
    news_list = soup.find("ul", class_="block-list232 list-unstyled gpLiMarginB gpAvgList gp-li-mb20 gp-li-mt20 pid-4371e738-0f5d-4526-959b-a56bf1abab5d sm-pid-4371e738-0f5d-4526-959b-a56bf1abab5d xs-pid-4371e738-0f5d-4526-959b-a56bf1abab5d xxs-pid-4371e738-0f5d-4526-959b-a56bf1abab5d")
...
def _parse_list_item(item: BeautifulSoup, base_url: str) -> ResultSummary | None:
    href_node  = item.find("a",href = True)
    ...
    title_node = item.find("p",class_="gp-ellipsis gpArticleTitle gp-f16 pid-4371e738-0f5d-4526-959b-a56bf1abab5d sm-pid-4371e738-0f5d-4526-959b-a56bf1abab5d xs-pid-4371e738-0f5d-4526-959b-a56bf1abab5d xxs-pid-4371e738-0f5d-4526-959b-a56bf1abab5d",recursive=True)
...
def _parse_date(item: BeautifulSoup) -> str | None:
    date_node = item.find("div", class_="date gp-f14 gp-fr gpArticleDate",recursive=True)
